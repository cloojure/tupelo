...
TEMP TODO:  see source code http://github.com/cloojure/cooljure/blob/master/src/cooljure/parse.clj

=== cooljure.base64 - Convert to/from base64 encoding

TEMP TODO:  see source code http://github.com/cloojure/cooljure/blob/master/src/cooljure/base64.clj

=== cooljure.y64 - Convert to/from the URL-safe Y64 encoding (Yahoo YUI library).

TEMP TODO:  see source code http://github.com/cloojure/cooljure/blob/master/src/cooljure/y64.clj
