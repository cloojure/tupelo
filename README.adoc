...
(-> 1
    (inc)
    (spy)       ; want to print value at this location in pipeline
    (* 2))
...
[source,clojure]
----
(spy <value>)                   ; print <value> w/o custom message string
(spy <value> :msg msg-str)      ; works with ->   (the ":msg" keyword is required)
(spy :msg msg-str <value>)      ; works with ->>  (the ":msg" keyword is required)
