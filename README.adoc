...
There are convenient functions for this purpose [in the Tupelo library][1].  In particular, the
functions `contains-elem?`, `contains-key?`, and `contains-val?` are very useful.  
