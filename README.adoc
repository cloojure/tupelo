...
The current version of Tupelo makes use of `clojure.spec` and therefore requires Clojure
`1.9.0-alpha13` or higher.  It also requires Java 1.8.  

The newest version of Tupelo using Clojure 1.8 is `[tupelo "0.1.69"]`
...
The Tupelo library attempts to resolve this confusion situation by providing both positive and
