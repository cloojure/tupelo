...
.Datomic Conceptual Model
****
[big]#*_Datomic is conceptually structured as a simple map, where all keys are EID values, and
each value is a map of attribute-value pairs._*#

An equivlent example in Clojure would look like:
