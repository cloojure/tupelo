...
tuple. In this case, we can use the function `td/query-set` instead.  In this case, the function
returns a set of scalars as output rather than a set of tuples:
