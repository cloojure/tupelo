...
(deftest parse-float
  (testing "basic"
    ...
    (is (rel=  0.1                          (cool/parse-float "0.1")            :digits 7))
    (is (rel=  3.141592654                  (cool/parse-float "3.141592654")    :digits 7))
  ...
  (testing "with :or"
    ...
    (is (rel=  (/ 1 10)                     (cool/parse-float "0.1"              :or 0) :digits 7))
    (is (rel=  3.141592654                  (cool/parse-float "3.141592654"      :or 0) :digits 7)))
  ))
...
(deftest parse-double
  (testing "basic"
    ...
    (is (rel=  (double (/ 1 10) )           (cool/parse-double "0.1")           :digits 9))
    (is (rel=  Math/PI                      (cool/parse-double "3.141592654")   :digits 9))) 
  ...
  (testing "with :or"
    ...
    (is (rel= (/ 1 10)                      (cool/parse-double "0.1"         :or 0)     :digits 9))
    (is (rel= Math/PI                       (cool/parse-double "3.141592654" :or 0)     :digits 9))
  ))
